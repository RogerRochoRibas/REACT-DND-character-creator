          ...
          <section class="attributes">
            <div class="scores">
              <ul>
                ...
                <li>
                  <div class="score">
                    <label for="Wisedom">Wisedom</label>
            ...
            <div class="attr-applications">
              ...
              <div class="saves list-section box">
                <ul>
                  ...
                  <li>
                    <label for="Wisedom-save">Wisedom</label>
...
{ "name" => "Survival", "attr" => "Wis"}, \
 ...
 %> */}
                  ...
                  <li>
                    <label for="Nature">
                      Nature <span class="skill">(Wis)</span>
                    </label>
            ...
            <div>
              ...
              <div class="money">
                <ul>
                  ...
                  <li>
                    <label for="sp">cp</label>
                    <input name="cp" />
                  </li>
                  <li>
                    <label for="ep">cp</label>
                    <input name="cp" />
                  </li>
                  <li>
                    <label for="gp">cp</label>
                    <input name="cp" />
                  </li>
                  <li>
                    <label for="pp">cp</label>
                    <input name="cp" />
                  </li>
                </ul>
              </div>
